...
const routes: Routes = [
  ...
  { path: 'phome', loadChildren: './pages/project-home/project-home.module#ProjectHomePageModule' },
  { path: 'exports', loadChildren: './pages/exports/exports.module#ExportsPageModule' },
